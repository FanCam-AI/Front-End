<script>
    ...
    async function approveQR(token) {
        let status = "";
...
{#if isUpdated}
    ...
    <main class="plan-flow">
        ...
        <section class="subscribe-container">
            <div class="plan-grid">
                <div class="plan-card">
                    <h3 style="color: #black; font-weight: 800;">PREMIUM</h3>
                    ...
                    <div class="feature">4. Save to My Gallery (max 300)</div>
                    <div class="feature">5. DragToGIF Chrome Extension Access</div>
                    ...
                    {:else if offerings}
                        {#each offerings.current?.availablePackages as pkg}
                            ...
                            <button class="cta w-full" on:click={handleClick}>
                                {currentPlan === "PREMIUM"
                ...
                <div class="plan-card">
                    <h3 style="color: #black; font-weight: 800;">FREE</h3>
